...
export default function Header() {
    ...
    <header className='shadow sticky z-50 top-0'>
        <nav className='bg-black border-whte-200 px-4
        lg:px-6 py-2.5'>
        ...
        items-center mx-auto max-w-screen-xl'>
            ...
            {/* <div className='flex items-center lg:order-2'>
                ...
                focus:right-4 focus:ring-orange-300 font-medium rounded-lg
            ...
            id="mobile-menu-2">
             ...
             lg:space-x-8 lg:mt-0'>
                <li>
                    ...
                    lg:border-0 hover:text-orange-700 lg:p-0 text-white`}>
                        Home
